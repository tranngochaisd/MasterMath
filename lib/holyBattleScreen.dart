    ...
    if (updateScore != score) {
      setState(() {
        ...
        if (updateScore > 0) {
          ...
          print('Value2.answer' + Value2[questionNumber].answer.toString());
        }
        if (updateScore < 0) {
          Value2[questionNumber].answer = -1;
          print('Value2.answer' + Value2[questionNumber].answer.toString());
        ...
        if (questionNumber == 15) {
          ...
          if (playerOder == 1) {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => gameOverP1()));
            print('đã chạy gameOver');
          }
          if (playerOder == 2) {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => gameOverP2()));
            print('đã chạy gameOver');
          }
        } else {
          handlerGamePlaye(10, 100, m);
